package com.example.reactnativevisioncameraselfiesegmentation;
  ...
  private static void initializeFlipper(Context context, ReactInstanceManager reactInstanceManager) {
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.example.reactnativevisioncameraselfiesegmentation.ReactNativeFlipper");
        aClass
